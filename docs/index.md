...
For example, the `read_xarray` function will interpret chunked arrays as instances of [`xarray.DataArray`](https://docs.xarray.dev/en/stable/generated/xarray.DataArray.html), and groups of chunked arrays as instances of [`datatree.DataTree`](https://xarray-datatree.readthedocs.io/en/latest/generated/datatree.DataTree.html#datatree.DataTree).
...
# read N5 group as an xarray DataTree
```python
from fibsem_tools import read_xarray
