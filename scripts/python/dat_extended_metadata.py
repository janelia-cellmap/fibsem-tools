...
def  main():
    ...
    parser = argparse.ArgumentParser(description="Save the extended metadata from the footer of a .dat file as json and xml "
    ...
    if not os.path.exists(args.data_root): 
        raise FileNotFoundError(f'The data root path {args.data_root} could not be found.')    
