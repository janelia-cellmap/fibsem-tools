...
import zarr
from fibsem_tools.metadata.multiscale_generation import ClusterSpec, DownsamplingSpec, ReadableArrayStore, WriteableArrayStore, WorkerSpec, MultiscaleStorageSpec
...
def generate_spec(json_path: str, create_source: bool):
    ...
    spec = MultiscaleStorageSpec(source=source,
                             destination=dest,
