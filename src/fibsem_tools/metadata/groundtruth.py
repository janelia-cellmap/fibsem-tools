...
classNameDict = {
    ...
    26: InstanceName(short='NEChrom', long='Nuclear euchromatin'),
    27: InstanceName(short='Nucleoplasm', long='Nucleoplasm'),
    28: InstanceName(short='Nucleolus', long='Nucleolus'),
    29: InstanceName(short='Microtubules out', long='Microtubules out'),
    30: InstanceName(short='Centrosome', long='Centrosome'),
    31: InstanceName(short='Distal appendages', long='Distal appendages'),
    32: InstanceName(short='Subdistal appendages', long='Subdistal appendages'),
    ...
    40: InstanceName(short='HChrom Point Annot.', long='Heterochromatin point annotation'),
